  ...
  return (
    <div className=''>
      ...
      <div className='flex content-center ml-40'>
        <div>
          <img src="../assets/destination/image-moon.png" alt="" className='moonİmg' />
        </div>
        <div className='ml-32'>
          <div className='flex'>
            <Link to="/destination">
          ...
          <div className='text-white'>
            <div className='flex'>
              <h1 className='text-5xl mt-3 ml-8 '>MOON</h1>
              <div className='flex ml-11 mt-5'>
                <div className=''>
                  <p className='text-xs'>AVG. DISTANCE</p>
                  <p className='text-2xl'>225 MIL. KM</p>
                </div>
                <div className='ml-10'>
                  <p className='text-xs'>EST. TRAVEL TIME</p>
                  <p className='text-2xl'>9 MONTHS</p>
                </div>
              </div>
            </div>
